<template>
 <v-container>
   <section class="product mt-3 elevation-10">
     <v-layout row wrap>
       <v-flex xs12 lg6>
         <img src="https://picsum.photos/550" class="product_img">
       </v-flex>
       <v-flex xs12 lg6>
         <div class="product_info">
           <h5 class="product_title display-1 mb-3 mt-3">Lorem ipsum dolor sit.</h5>
           ...
           <div class="title mb-5">
             <p class="product_title mb-2">Description: </p>Lorem ipsum dolor sit amet.
           </div>
